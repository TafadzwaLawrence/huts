...
import { MapPin, Search, Home, Bed, Bath, Square, ArrowRight, Check, Building2, Car, Wifi, Shield, ChevronRight } from 'lucide-react'
...
export default async function HarareRentalsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-b from-white via-[#F8F9FA] to-white py-16 md:py-24 overflow-hidden">
        ...
        <div className="container-main max-w-6xl relative">
          ...
          <nav aria-label="Breadcrumb" className="mb-8 flex items-center gap-1.5 text-sm text-[#495057]">
            ...
            <span className="text-[#212529] font-medium">Rentals in Harare</span>
          </nav>

          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#212529] mb-6 tracking-tight leading-tight">
              Properties for Rent in Harare, Zimbabwe
            </h1>
            <p className="text-lg md:text-xl text-[#495057] mb-8 leading-relaxed">
            ...
            {/* Search Bar */}
            <div className="bg-white rounded-2xl shadow-xl border-2 border-[#E9ECEF] p-2 mb-8">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              {[
                ...
                <div key={stat.label} className="bg-white border border-[#E9ECEF] rounded-xl p-4">
                  <div className="text-2xl md:text-3xl font-bold text-[#212529] mb-1">{stat.value}</div>
                  <div className="text-xs text-[#ADB5BD]">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-12 md:py-16 bg-[#F8F9FA] border-y border-[#E9ECEF]">
        <div className="container-main">
          <h2 className="text-2xl md:text-3xl font-bold text-[#212529] mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
            {topNeighborhoods.map(({ name, count }: any) => (
              <Link
                ...
                className="group bg-white border-2 border-[#E9ECEF] rounded-xl p-4 text-center hover:border-[#212529] hover:shadow-lg hover:-translate-y-1 transition-all"
              >
                <div className="w-10 h-10 bg-[#F8F9FA] group-hover:bg-[#212529] rounded-lg flex items-center justify-center mx-auto mb-3 transition-colors">
                  <MapPin size={ICON_SIZES.lg} className="text-[#495057] group-hover:text-white transition-colors" />
                </div>
                <div className="text-xl font-bold text-[#212529] mb-1">{count}</div>
                <div className="text-sm font-medium text-[#495057] line-clamp-1">{name}</div>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container-main">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link
              href="/search?city=Harare&type=rent"
              className="group inline-flex items-center gap-2 text-sm font-semibold text-[#212529] border-2 border-[#E9ECEF] px-5 py-2.5 rounded-full hover:border-[#212529] hover:bg-[#212529] hover:text-white transition-all"
            >
          ...
          {properties && properties.length > 0 ? (
                ...
                return (
                  ...
                  >
                    <article className="border border-[#E9ECEF] rounded-2xl overflow-hidden bg-white hover:border-[#212529] hover:shadow-xl transition-all duration-300">
                      ...
                      <div className="p-4">
                        <h3 className="font-semibold text-[#212529] text-sm mb-2 leading-snug line-clamp-1 group-hover:underline">
                          {property.title}
                        </h3>
            ...
            <div className="text-center py-16 bg-[#F8F9FA] rounded-2xl border-2 border-dashed border-[#E9ECEF]">
              <Home size={ICON_SIZES['3xl']} className="mx-auto text-[#ADB5BD] mb-4" />
              <h3 className="text-xl font-bold text-[#212529] mb-2">No properties found</h3>
              <p className="text-[#495057] mb-6">Try adjusting your search or browse all areas</p>
              <Link
                href="/search"
      ...
      <section className="py-16 md:py-20 bg-[#F8F9FA] border-t border-[#E9ECEF]">
        <div className="container-main max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-[#495057] text-lg leading-relaxed mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {[
                ...
                <div key={area.name} className="bg-white border-2 border-[#E9ECEF] rounded-xl p-5">
                  <h4 className="font-bold text-[#212529] mb-2 flex items-center gap-2">
                    <MapPin size={ICON_SIZES.lg} className="text-[#495057]" />
                    {area.name}
                  </h4>
                  <p className="text-sm text-[#495057] leading-relaxed">{area.desc}</p>
                  <Link
                    href={`/search?city=Harare&neighborhood=${encodeURIComponent(area.name)}&type=rent`}
                    className="inline-flex items-center gap-1 text-sm font-medium text-[#212529] mt-3 hover:underline"
                  >
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              {[
                ...
                <div key={item.title} className="bg-white border border-[#E9ECEF] rounded-xl p-5 text-center">
                  <div className="w-12 h-12 bg-[#F8F9FA] rounded-xl flex items-center justify-center mx-auto mb-3">
                    <item.icon size={ICON_SIZES.xl} className="text-[#212529]" />
                  </div>
                  <h4 className="font-bold text-[#212529] mb-2">{item.title}</h4>
            ...
            <ul className="space-y-2 text-[#495057] mb-6">
              <li className="flex items-start gap-3">
                <Check size={ICON_SIZES.lg} className="text-[#212529] mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-[#212529] text-white rounded-2xl p-8 mt-10">
              ...
              <Link
                href="/search?city=Harare&type=rent"
                className="inline-flex items-center gap-2 bg-white text-[#212529] px-8 py-4 rounded-xl font-bold hover:bg-[#F8F9FA] transition-all"
              >
                <Search size={ICON_SIZES.lg} />
                Start Searching Now
