    ...
    <div className="min-h-screen bg-[#F8F9FA]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="h-10 w-32 bg-[#E9ECEF] rounded-lg animate-pulse" />
        </div>

        {/* Property Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-white rounded-xl overflow-hidden border border-[#E9ECEF]">
              {/* Image Skeleton */}
              <div className="h-48 bg-[#E9ECEF] animate-pulse" />
              
              {/* Content Skeleton */}
              <div className="p-4">
                <div className="h-6 w-3/4 bg-[#E9ECEF] rounded animate-pulse mb-2" />
                <div className="h-4 w-1/2 bg-[#E9ECEF] rounded animate-pulse mb-4" />
                
                <div className="flex gap-4 pt-3 border-t border-[#E9ECEF]">
