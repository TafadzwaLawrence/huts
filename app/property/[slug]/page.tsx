...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    ...
    let { data: property } = await supabase
      .from('properties')
      .select('title, description, city, price, sale_price, listing_type, rental_period, nightly_price, bedrooms, bathrooms, property_type, property_images(url), created_at, updated_at, published_at')
      .eq('slug', slug)
      .single()
