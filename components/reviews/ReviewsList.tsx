      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 border-2 border-border rounded hover:border-border transition-colors"
          >
            <span className="text-sm">
              {sortOptions.find((opt) => opt.value === sortBy)?.label}
            </span>
            <ChevronDown size={ICON_SIZES.md} className="text-foreground" />
          </button>
