...
export const COUNTRIES: Country[] = [
  ...
  { code: 'PM', name: 'Saint Pierre & Miquelon', dial: '+508' },
...
interface PhoneInputProps {
  ...
  onChange: (local: string, dialCode: string) => void
  placeholder?: string
  required?: boolean
  id?: string
}
...
export default function PhoneInput({
  ...
  const selected = COUNTRIES.find((c) => c.dial === dialCode) ?? COUNTRIES.find((c) => c.code === 'ZW')!
        ...
        >
          ...
          <div className="flex items-center gap-2 px-3 py-2.5 bg-[#F8F9FA] border-b border-[#E9ECEF]">
            ...
            <input
              ...
              className="flex-1 text-sm text-[#212529] placeholder:text-[#ADB5BD] bg-transparent focus:outline-none"
            />
            {search && (
              <button
                type="button"
